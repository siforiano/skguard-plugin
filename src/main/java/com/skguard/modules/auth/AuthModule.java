...
public class AuthModule implements SecurityModule, Listener {
    ...
    public AuthModule(SKGuard plugin) {
        this.plugin = plugin;
    ...
    public void forceLogin(Player player) {
        ...
        if (staffPin != null && staffPin.isEnabled() && player.hasPermission("SKGuard.staff")) {
    ...
    @EventHandler
    public void onCaptchaSuccess(com.skguard.api.event.CaptchaSuccessEvent event) {
        Player player = event.getPlayer();
    ...
    public void onCommand(PlayerCommandPreprocessEvent event) {
        ...
        if (cmd.equals("/2fa")) {
            event.setCancelled(true);
            String masterKey = plugin.getConfig().getString("general.master-key", "SKGuardDefaultKey123!");
            ...
            if (sub.equals("setup")) {
                ...
                usersConfig.set(uuid + ".temp_2fa_secret", com.skguard.util.EncryptionUtil.encrypt(secret, masterKey));
                saveUsers();
            ...
            if (sub.equals("confirm")) {
                ...
                String tempSecret = com.skguard.util.EncryptionUtil.decrypt(encryptedTemp, masterKey);
            ...
            if (sub.equals("verify")) {
                ...
                String secret = com.skguard.util.EncryptionUtil.decrypt(encryptedSecret, masterKey);
