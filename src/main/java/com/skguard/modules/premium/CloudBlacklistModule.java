 ...
 * Automatically bans players who are confirmed cheaters on other servers using SKGuard.
 * </p>
 * 
...
public class CloudBlacklistModule implements SecurityModule, Listener {
    ...
    public CloudBlacklistModule(SKGuard plugin) {
        this.plugin = plugin;
    ...
    @Override
    public void reload() {
        this.apiEndpoint = plugin.getConfig().getString("modules.CloudBlacklist.api-endpoint", "https://api.SKGuard.net/blacklist");
    ...
    public void onJoin(PlayerJoinEvent event) {
        ...
        if (isBlacklisted(uuid)) {
            if (autoBan) {
                ...
                player.kickPlayer("§c§lGLOBAL BAN\n\n§7You are banned from the SKGuard network.\n§7Reason: §fConfirmed cheater\n\n§7Appeal at: §bSKGuard.net/appeal");
