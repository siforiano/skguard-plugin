package com.skguard.integration;
...
public class DiscordWebhook implements SecurityModule {
    ...
    public DiscordWebhook(SKGuard plugin) {
        this.plugin = plugin;
        ...
        asyncExecutor.submit(() -> {
            try {
                String json = String.format(
                        "{\"embeds\":[{\"title\":\"%s\",\"description\":\"%s\",\"color\":%d,\"footer\":{\"text\":\"SKGuard Security\"}}]}",
                ...
                connection.setRequestProperty("User-Agent", "SKGuard-Plugin");
