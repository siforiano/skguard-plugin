...
/**
 * Manages the lifecycle of all security modules in SoulGuard.
 * <p>
...
public class ModuleManager {
    ...
    public ModuleManager(SoulGuard plugin) {
        this.plugin = plugin;
    ...
    public void registerModule(ModuleGroup group, SecurityModule module) {
        ...
        if (enabledInConfig) {
            enableModule(module);
            com.soulguard.util.ConsoleUtil.moduleLoad(module.getName(), true);
        } else {
            com.soulguard.util.ConsoleUtil.moduleLoad(module.getName(), false);
        }
    }
