...
import com.soulguard.database.PunishmentManager.Punishment;
import com.soulguard.database.PunishmentManager.PunishmentType;
...
public class ModerationModule implements SecurityModule, Listener {
    ...
    public ModerationModule(SoulGuard plugin) {
        this.plugin = plugin;
    }
    ...
    public void onLogin(AsyncPlayerPreLoginEvent event) {
        ...
        if (ban != null) {
            ...
            event.disallow(AsyncPlayerPreLoginEvent.Result.KICK_BANNED,
                    ColorUtil.translate("&c&l[SoulGuard] &7You are BANNED" + timeStr + "\n&fReason: &7" + ban.reason));
        }
    }
    ...
    public void onChat(AsyncPlayerChatEvent event) {
        ...
        if (mute != null) {
            ...
            player.sendMessage(ColorUtil.translate("&c&l[SoulGuard] &7You are currently MUTED" + timeStr + "."));
