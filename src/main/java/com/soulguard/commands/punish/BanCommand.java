package com.soulguard.commands.punish;
...
import com.soulguard.util.TimeUtil;
...
public class BanCommand implements SubCommand {
    ...
    public BanCommand(SoulGuard plugin) {
        this.plugin = plugin;
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        com.soulguard.database.PunishmentManager.Punishment p = new com.soulguard.database.PunishmentManager.Punishment(
                target.getUniqueId(), targetIp, com.soulguard.database.PunishmentManager.PunishmentType.BAN, reasonStr, sender.getName(), System.currentTimeMillis(), finalExpiry, true);
            ...
            org.bukkit.Bukkit.getScheduler().runTask(plugin, () -> {
                if (target.isOnline()) {
                    ...
                    if (pOnline != null) {
                        ...
                        pOnline.kickPlayer(ColorUtil.translate("&c&l[SoulGuard] &7You have been BANNED" + timeStr + "\n&fReason: &7" + reasonStr));
                    }
                }
