...
public class MuteCommand implements SubCommand {
    ...
    public MuteCommand(SoulGuard plugin) {
        this.plugin = plugin;
    }
    ...
    public String getPermission() {
        return "soulguard.staff"; // Assumed permission for mute
    }
    ...
    com.soulguard.database.PunishmentManager.Punishment p = new com.soulguard.database.PunishmentManager.Punishment(
                target.getUniqueId(), targetIp, com.soulguard.database.PunishmentManager.PunishmentType.MUTE, reasonStr, sender.getName(), System.currentTimeMillis(), finalExpiry, true);
